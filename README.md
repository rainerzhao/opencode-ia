...
- **把沟通落下来：** 手工记录 IM、电话、会议和导入资料，形成有负责人、BU 与状态的需求。
...
| 工作区 | 成员可以做什么 |
| --- | --- |
| 我的工作台 | 在一个高密度个人作战台中查看下一步、五类工作信号、本人待推进需求、澄清队列、私有会话、资产生命周期和近期里程碑，并直接继续处理。 |
...
![OpenCode 团队 AI 工作台个人作战台](docs/dev-loop-runs/2026-09-23-p2e-full-workbench-acceptance/artifacts/screenshots/home-1440-populated.png)

本轮以真实填充态覆盖工作台、需求、AI、方案、知识、Skill 与管理七个工作区；验收范围、自动化结果、截图索引和生产边界见 [P2E 桌面工作台总验收报告](docs/dev-loop-runs/2026-09-23-p2e-full-workbench-acceptance/04-acceptance-report.md)。

首页中的需求标题和会话标题只来自当前账号有权访问的个人数据；正文、原始沟通和附件不会进入首页概览，管理员与团队聚合视图也不会因此获得成员私人内容。
...
- 前端以可读、可操作、可沉淀的工作台体验为先；OpenCode 对话是流程能力入口，而非全站的视觉中心。
